...
#define ASSISTANCE_WITHOUT_PEDAL_ROTATION_THRESHOLD 
#define PEDAL_TORQUE_PER_10_BIT_ADC_STEP_X100 0
...
#define LIGHTS_CONFIGURATION_1 6
#define LIGHTS_CONFIGURATION_2 7
#define LIGHTS_CONFIGURATION_3 1
#define STREET_MODE_POWER_LIMIT_ENABLED 0
#define STREET_MODE_POWER_LIMIT 500
#define STREET_MODE_SPEED_LIMIT 0
...
#define EMTB_ASSIST_LEVEL_4 240
#define WALK_ASSIST_LEVEL_1 0
#define WALK_ASSIST_LEVEL_2 0
#define WALK_ASSIST_LEVEL_3 0
#define WALK_ASSIST_LEVEL_4 0
#define WALK_ASSIST_THRESHOLD_SPEED_X10 0
#define WALK_ASSIST_DEBOUNCE_ENABLED 0
#define WALK_ASSIST_DEBOUNCE_TIME 60
#define CRUISE_TARGET_SPEED_LEVEL_1 0
#define CRUISE_TARGET_SPEED_LEVEL_2 0
#define CRUISE_TARGET_SPEED_LEVEL_3 0
#define CRUISE_TARGET_SPEED_LEVEL_4 0
...
#define STREET_MODE_WALK_ENABLED 0
