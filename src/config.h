...
#define LI_ION_CELL_VOLTS_2_OF_6 3.5
#define LI_ION_CELL_VOLTS_1_OF_6 3.3
#define LI_ION_CELL_VOLTS_EMPTY 3.15
#define WHEEL_PERIMETER 2050
#define WHEEL_MAX_SPEED 28
