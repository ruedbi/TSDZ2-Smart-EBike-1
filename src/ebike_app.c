...
static uint8_t ui8_delay_display_array[DATA_INDEX_ARRAY_DIM] = {DELAY_DISPLAY_DATA_1, DELAY_DISPLAY_DATA_2, DELAY_DISPLAY_DATA_3,
																DELAY_DISPLAY_DATA_4, DELAY_DISPLAY_DATA_5, DELAY_DISPLAY_DATA_6};
...
uint16_t calc_battery_soc_x10(uint16_t ui16_battery_soc_offset_x10, uint16_t ui16_battery_soc_step_x10, uint16_t ui16_cell_volts_max_x100,
...
// minimum value for these displays
	...
	ui8_duty_cycle_ramp_up_inverse_step_default = map_ui8((uint8_t)MOTOR_ACCELERATION, (uint8_t)0, (uint8_t)100,
	...
	ui8_duty_cycle_ramp_down_inverse_step_default = map_ui8((uint8_t)MOTOR_DECELERATION, (uint8_t)0, (uint8_t)100,
...
// field weakening enabled
	...
	if ((ui16_motor_speed_erps > MOTOR_SPEED_FIELD_WEAKENING_MIN) && (ui8_adc_battery_current_filtered < ui8_controller_adc_battery_current_target)
...
// for XH18)
	...
	if ((ui8_brake_state) || (!ui8_motor_enabled) || (ui8_system_state == ERROR_MOTOR_BLOCKED) || (ui8_system_state == ERROR_MOTOR_CHECK)
		|| (ui8_system_state == ERROR_BATTERY_OVERCURRENT) || (ui8_system_state == ERROR_THROTTLE) || (ui8_assist_level == OFF)
		|| (ui8_riding_mode_parameter == 0U) || (ui8_battery_SOC_saved_flag)
	...
	if (ui8_motor_enabled
		&& ((ui8_system_state == ERROR_MOTOR_BLOCKED) || (ui8_system_state == ERROR_MOTOR_CHECK) || (ui8_system_state == ERROR_BATTERY_OVERCURRENT)
...
static void set_motor_ramp(void) {
	...
	if (ui16_wheel_speed_x10 >= 200) {
		...
		ui8_duty_cycle_ramp_up_inverse_step = map_ui8((uint8_t)(ui16_wheel_speed_x10 >> 2),
													  ...
													  (uint8_t)ui8_duty_cycle_ramp_up_inverse_step_default, (uint8_t)PWM_DUTY_CYCLE_RAMP_UP_INVERSE_STEP_MIN);
		...
		ui8_tmp = map_ui8(ui8_pedal_cadence_RPM,
						  (uint8_t)20, // 20 rpm
						  (uint8_t)70, // 70 rpm
						  (uint8_t)ui8_duty_cycle_ramp_down_inverse_step_default, (uint8_t)PWM_DUTY_CYCLE_RAMP_DOWN_INVERSE_STEP_MIN);
...
static void apply_power_assist(void) {
	...
	if ((ui8_pedal_cadence_RPM > 0U) || (ui8_startup_assist_adc_battery_current_target)) {
		...
		uint32_t ui32_power_assist_x100 = (((uint32_t)(ui8_pedal_cadence_RPM * ui8_power_assist_multiplier_x50)) * ui32_pedal_torque_x100)
										  >> 9; // see note below
...
#define eMTB_ASSIST_DENOMINATOR_MIN 10
	...
	if (((ui16_adc_pedal_torque_delta) && (ui8_pedal_cadence_RPM > 0U)) || (ui8_startup_assist_adc_battery_current_target)) {
		...
		uint16_t ui16_eMTB_adc_pedal_torque_delta = (uint16_t)(
			(uint32_t)((ui16_adc_pedal_torque_delta * ui16_adc_pedal_torque_delta) + ui16_eMTB_assist_denominator) / ui16_eMTB_assist_denominator);
...
// smooth start
	...
	if ((ui8_pedal_cadence_RPM > 0U) || (ui8_startup_assist_adc_battery_current_target)) {
		...
		// calculate power assist by multiplying human power with the power assist multiplier
		uint32_t ui32_power_assist_x100 = (((uint32_t)(ui8_pedal_cadence_RPM * ui8_power_assist_multiplier_x50)) * ui16_pedal_torque_x100)
										  >> 9; // see note below
...
#if CRUISE_MODE_WALK_ENABLED
#if ENABLE_BRAKE_SENSOR
	if ((ui16_wheel_speed_x10 >= ui8_cruise_threshold_speed_x10) && (!m_configuration_variables.ui8_street_mode_enabled) && (ui8_cruise_assist_flag)
...
static void apply_throttle(void) {
	...
	ui8_throttle_adc_in = map_ui8((uint8_t)(ui16_adc_throttle >> 2), (uint8_t)ADC_THROTTLE_MIN_VALUE, (uint8_t)ADC_THROTTLE_MAX_VALUE, (uint8_t)0,
								  (uint8_t)255);
	...
	uint8_t ui8_adc_battery_current_target_throttle = map_ui8((uint8_t)ui8_adc_throttle_assist, (uint8_t)0, (uint8_t)255, (uint8_t)0,
	...
	if (ui8_adc_battery_current_target_throttle > ui8_adc_battery_current_target) {
		...
		if (ui16_wheel_speed_x10 >= 255) {
			...
			ui8_duty_cycle_ramp_up_inverse_step = map_ui8((uint8_t)ui16_wheel_speed_x10, (uint8_t)40, (uint8_t)255,
														  (uint8_t)THROTTLE_DUTY_CYCLE_RAMP_UP_INVERSE_STEP_DEFAULT,
														  (uint8_t)THROTTLE_DUTY_CYCLE_RAMP_UP_INVERSE_STEP_MIN);

			ui8_duty_cycle_ramp_down_inverse_step = map_ui8((uint8_t)ui16_wheel_speed_x10, (uint8_t)40, (uint8_t)255,
															(uint8_t)PWM_DUTY_CYCLE_RAMP_DOWN_INVERSE_STEP_DEFAULT,
															(uint8_t)PWM_DUTY_CYCLE_RAMP_DOWN_INVERSE_STEP_MIN);
		}
...
static void apply_temperature_limiting(void) {
	...
	if (ui8_motor_temperature_min_value_to_limit_array[TEMPERATURE_SENSOR_TYPE] >= ui8_motor_temperature_max_value_to_limit_array[TEMPERATURE_SENSOR_TYPE]) {
		...
		ui8_adc_battery_current_target = (uint8_t)map_ui16(
			ui16_motor_temperature_filtered_x10, (uint16_t)((uint8_t)ui8_motor_temperature_min_value_to_limit_array[TEMPERATURE_SENSOR_TYPE] * (uint8_t)10U),
			(uint16_t)((uint8_t)ui8_motor_temperature_max_value_to_limit_array[TEMPERATURE_SENSOR_TYPE] * (uint8_t)10U), ui8_adc_battery_current_target, 0);
	}
}
...
static void apply_speed_limit(void) {
	if (m_configuration_variables.ui8_wheel_speed_max > 0U) {
		uint16_t speed_limit_low = (uint16_t)((uint8_t)(m_configuration_variables.ui8_wheel_speed_max - 2U)
...
static void calc_cadence(void) {
	...
	ui16_cadence_ticks_count_min_speed_adj = map_ui16(ui16_wheel_speed_x10, 40, 400, CADENCE_SENSOR_CALC_COUNTER_MIN,
...
#define READ_BATTERY_VOLTAGE_FILTER_COEFFICIENT 2
	...
	ui16_battery_voltage_filtered_x1000 = (ui16_adc_battery_voltage_accumulated >> READ_BATTERY_VOLTAGE_FILTER_COEFFICIENT)
...
// calculate coaster brake threshold
	...
	if (ui16_adc_pedal_torque > ui16_adc_pedal_torque_offset) {
		...
		if ((ui8_torque_sensor_calibrated) && (m_configuration_variables.ui8_torque_sensor_adv_enabled)) {
			...
			ui16_adc_pedal_torque_delta = (((ui16_temp
											 * ((ui16_temp / ADC_TORQUE_SENSOR_ANGLE_COEFF + ADC_TORQUE_SENSOR_ANGLE_COEFF_X10)
			...
			if (ui16_adc_pedal_torque_delta < ADC_TORQUE_SENSOR_RANGE_TARGET_MAX) {
				ui16_temp = (ui16_adc_pedal_torque_delta * ADC_TORQUE_SENSOR_RANGE_TARGET_MAX)
							/ (ADC_TORQUE_SENSOR_RANGE_TARGET_MAX
							   - (((ADC_TORQUE_SENSOR_RANGE_TARGET_MAX - ui16_adc_pedal_torque_delta) * 10) / PEDAL_TORQUE_ADC_ANGLE_ADJ));
	...
	if ((ui8_torque_sensor_calibrated) && (m_configuration_variables.ui8_torque_sensor_adv_enabled)) {
		ui16_human_power_x10 = (uint16_t)(((uint32_t)ui16_adc_pedal_torque_delta * ui8_pedal_torque_per_10_bit_ADC_step_calc_x100 * ui8_pedal_cadence_RPM)
										  / 96);
	}
	else {
...
#define MOTOR_CHECK_ERPS_THRESHOLD			 20 // 20 ERPS
	...
	if (((m_configuration_variables.ui8_riding_mode == POWER_ASSIST_MODE) || (m_configuration_variables.ui8_riding_mode == TORQUE_ASSIST_MODE)
		 || (m_configuration_variables.ui8_riding_mode == HYBRID_ASSIST_MODE) || (m_configuration_variables.ui8_riding_mode == eMTB_ASSIST_MODE))
		&& (ui8_adc_throttle_assist == 0U)) {
	...
	if ((ui16_motor_speed_erps > MOTOR_CHECK_ERPS_THRESHOLD) && ((ui8_riding_torque_mode) || (m_configuration_variables.ui8_riding_mode == CADENCE_ASSIST_MODE))
...
#define ADC_TORQUE_SENSOR_DELTA_THRESHOLD	   (uint16_t)((ADC_TORQUE_SENSOR_RANGE_TARGET >> 1) + 20)
	...
	if ((ui16_adc_pedal_torque_delta_no_boost > ADC_TORQUE_SENSOR_DELTA_THRESHOLD) && (!ui8_startup_assist_flag) && (ui8_riding_torque_mode)
...
#define MOTOR_ERPS_SPEED_THRESHOLD			 180
	...
	// check speed sensor
	if ((ui16_motor_speed_erps > MOTOR_ERPS_SPEED_THRESHOLD) && (m_configuration_variables.ui8_riding_mode != WALK_ASSIST_MODE)
					...
					case TURBO:
						...
						case 2:
							if (ui8_lights_configuration_2 == 9) {
								...
								m_configuration_variables.ui8_assist_without_pedal_rotation_enabled = !m_configuration_variables
...
#warning "ruedbi: code removed"
			...
			if (m_configuration_variables.ui8_auto_display_data_enabled) {
				if ((ui8_lights_flag) && (ui8_menu_index == 0U) && (!ui8_display_battery_soc_flag) && (!ui8_display_torque_sensor_value_flag)
...
// set lights
			...
			ui8_adc_battery_current_max_temp_2 = (uint8_t)(
				(uint32_t)(ui32_adc_battery_power_max_x1000_array[m_configuration_variables.ui8_street_mode_enabled] / ui16_battery_voltage_filtered_x1000));
			...
			ui8_pedal_torque_per_10_bit_ADC_step_x100 = ui8_pedal_torque_per_10_bit_ADC_step_x100_array[m_configuration_variables
		...
		if (ui8_display_data_enabled) {
			...
			if ((ui8_display_battery_soc_flag) || ((ui8_startup_counter < DELAY_MENU_ON) && (ui8_assist_level == TURBO))) {
				...
				ui16_display_data = ui16_display_data_factor / ui16_adc_torque;
					 ...
					 && ((ui8_assist_level < TOUR) || (ui8_display_alternative_lights_configuration))) { // OFF & ECO &
				// alternative lights
				// configuration
...
static void calc_oem_wheel_speed(void) {
	if (ui8_display_ready_flag) {
		...
		ui16_oem_wheel_speed_time = (uint16_t)(
			(uint32_t)(uint16_t)(ui8_oem_wheel_diameter * 80U * 10U) * ui16_wheel_speed_sensor_ticks
...
uint16_t read_battery_soc(void) {
	...
	case 0:
		...
		break; // undervoltage
	case 1:
		ui16_battery_SOC_calc_x10 = calc_battery_soc_x10(1, 250, LI_ION_CELL_VOLTS_1_X100, LI_ION_CELL_VOLTS_0_X100);
		break; // blink - empty
	case 2:
		ui16_battery_SOC_calc_x10 = calc_battery_soc_x10(250, 250, LI_ION_CELL_VOLTS_2_X100, LI_ION_CELL_VOLTS_1_X100);
		break; // 1 bars
	case 3:
		ui16_battery_SOC_calc_x10 = calc_battery_soc_x10(500, 250, LI_ION_CELL_VOLTS_3_X100, LI_ION_CELL_VOLTS_2_X100);
		break; // 2 bars
	case 4:
		ui16_battery_SOC_calc_x10 = calc_battery_soc_x10(750, 250, LI_ION_CELL_VOLTS_4_X100, LI_ION_CELL_VOLTS_3_X100);
		break; // 3 bars
	case 5:
...
//	ui16_battery_SOC_calc_x10 = 10; // don't care
	...
	case 0:
		...
		break; // undervoltage
	case 1:
		ui16_battery_SOC_calc_x10 = calc_battery_soc_x10(1, 167, LI_ION_CELL_VOLTS_1_X100, LI_ION_CELL_VOLTS_0_X100);
		break; // blink - empty
	case 2:
		ui16_battery_SOC_calc_x10 = calc_battery_soc_x10(167, 167, LI_ION_CELL_VOLTS_2_X100, LI_ION_CELL_VOLTS_1_X100);
		break; // 1 bars
	case 3:
		ui16_battery_SOC_calc_x10 = calc_battery_soc_x10(334, 167, LI_ION_CELL_VOLTS_3_X100, LI_ION_CELL_VOLTS_2_X100);
		break; // 2 bars
	case 4:
		ui16_battery_SOC_calc_x10 = calc_battery_soc_x10(500, 167, LI_ION_CELL_VOLTS_4_X100, LI_ION_CELL_VOLTS_3_X100);
		break; // 3 bars
	case 5:
		ui16_battery_SOC_calc_x10 = calc_battery_soc_x10(667, 167, LI_ION_CELL_VOLTS_5_X100, LI_ION_CELL_VOLTS_4_X100);
		break; // 4 bars
	case 6:
		ui16_battery_SOC_calc_x10 = calc_battery_soc_x10(834, 167, LI_ION_CELL_VOLTS_6_X100, LI_ION_CELL_VOLTS_5_X100);
		break; // 5 bars
	case 7:
		ui16_battery_SOC_calc_x10 = 1000;
		break; // 6 bars - full
...
#define CELL_VOLTS_CALIBRATION 8
	...
	uint16_t ui16_battery_soc_calc_temp_x10 = (ui16_battery_soc_offset_x10
