...
void EEPROM_init(void) {
    ...
    FLASH_SetProgrammingTime(
            FLASH_PROGRAMTIME_STANDARD);  // standard programming (erase and write) time mode
...
void EEPROM_controller(uint8_t ui8_operation, uint8_t ui8_byte_init) {
    ...
    case READ_FROM_MEMORY:
        ...
        // // NOT USED
        p_configuration_variables->ui8_battery_current_max =
                FLASH_ReadByte(ADDRESS_BATTERY_CURRENT_MAX);
        ...
        p_configuration_variables->ui8_startup_assist_enabled =
                FLASH_ReadByte(ADDRESS_STARTUP_ASSIST_ENABLED);

        p_configuration_variables->ui8_torque_sensor_estimated =
                FLASH_ReadByte(ADDRESS_TORQUE_SENSOR_ESTIMATED);

        p_configuration_variables->ui8_pedal_torque_per_10_bit_ADC_step_est_x100 =
                FLASH_ReadByte(ADDRESS_PEDAL_TORQUE_PER_10_BIT_ADC_STEP_X100);
        // for oem display
        p_configuration_variables->ui8_assist_without_pedal_rotation_enabled =
                FLASH_ReadByte(ADDRESS_MOTOR_ASSISTANCE_WITHOUT_PEDAL_ROTATION);

        p_configuration_variables->ui8_assist_with_error_enabled =
                FLASH_ReadByte(ADDRESS_MOTOR_ASSISTANCE_WITH_ERROR_ENABLED);
        p_configuration_variables->ui8_battery_SOC_percentage_8b =
                FLASH_ReadByte(ADDRESS_BATTERY_SOC);
        p_configuration_variables->ui8_set_parameter_enabled =
                FLASH_ReadByte(ADDRESS_SET_PARAMETER_ON_STARTUP);
        p_configuration_variables->ui8_street_mode_enabled =
                FLASH_ReadByte(ADDRESS_STREET_MODE_ON_STARTUP);
        p_configuration_variables->ui8_riding_mode = FLASH_ReadByte(ADDRESS_RIDING_MODE_ON_STARTUP);
        p_configuration_variables->ui8_lights_configuration =
                FLASH_ReadByte(ADDRESS_LIGHTS_CONFIGURATION_ON_STARTUP);
        p_configuration_variables->ui8_startup_boost_enabled =
                FLASH_ReadByte(ADDRESS_STARTUP_BOOST_ON_STARTUP);
        p_configuration_variables->ui8_auto_display_data_enabled =
                FLASH_ReadByte(ADDRESS_ENABLE_AUTO_DATA_DISPLAY);
        p_configuration_variables->ui8_soc_percent_calculation =
                FLASH_ReadByte(ADDRESS_SOC_PERCENT_CALC);

        p_configuration_variables->ui8_torque_sensor_adv_enabled =
                FLASH_ReadByte(ADDRESS_TORQUE_SENSOR_ADV_ON_STARTUP);
    ...
    case WRITE_TO_MEMORY:
        ...
        // ui8_array[ADDRESS_MOTOR_POWER_X10 - EEPROM_BASE_ADDRESS] =
        // p_configuration_variables->ui8_motor_power_x10; // NOT USED
        ui8_array[ADDRESS_BATTERY_CURRENT_MAX - EEPROM_BASE_ADDRESS] =
                p_configuration_variables->ui8_battery_current_max;

        ui8_array[ADDRESS_BATTERY_LOW_VOLTAGE_CUT_OFF_X10_0 - EEPROM_BASE_ADDRESS] =
                p_configuration_variables->ui16_battery_low_voltage_cut_off_x10 & 255;
        ui8_array[ADDRESS_BATTERY_LOW_VOLTAGE_CUT_OFF_X10_1 - EEPROM_BASE_ADDRESS] =
                (p_configuration_variables->ui16_battery_low_voltage_cut_off_x10 >> 8) & 255;

        ui8_array[ADDRESS_WHEEL_PERIMETER_0 - EEPROM_BASE_ADDRESS] =
                p_configuration_variables->ui16_wheel_perimeter & 255;
        ui8_array[ADDRESS_WHEEL_PERIMETER_1 - EEPROM_BASE_ADDRESS] =
                (p_configuration_variables->ui16_wheel_perimeter >> 8) & 255;

        ui8_array[ADDRESS_STARTUP_ASSIST_ENABLED - EEPROM_BASE_ADDRESS] =
                p_configuration_variables->ui8_startup_assist_enabled;

        ui8_array[ADDRESS_TORQUE_SENSOR_ESTIMATED - EEPROM_BASE_ADDRESS] =
                p_configuration_variables->ui8_torque_sensor_estimated;

        ui8_array[ADDRESS_PEDAL_TORQUE_PER_10_BIT_ADC_STEP_X100 - EEPROM_BASE_ADDRESS] =
                p_configuration_variables->ui8_pedal_torque_per_10_bit_ADC_step_est_x100;
        // for oem display
        ui8_array[ADDRESS_MOTOR_ASSISTANCE_WITHOUT_PEDAL_ROTATION - EEPROM_BASE_ADDRESS] =
                p_configuration_variables->ui8_assist_without_pedal_rotation_enabled;

        ui8_array[ADDRESS_MOTOR_ASSISTANCE_WITH_ERROR_ENABLED - EEPROM_BASE_ADDRESS] =
                p_configuration_variables->ui8_assist_with_error_enabled;
        ui8_array[ADDRESS_BATTERY_SOC - EEPROM_BASE_ADDRESS] =
                p_configuration_variables->ui8_battery_SOC_percentage_8b;
        ui8_array[ADDRESS_SET_PARAMETER_ON_STARTUP - EEPROM_BASE_ADDRESS] =
                p_configuration_variables->ui8_set_parameter_enabled;
        ui8_array[ADDRESS_STREET_MODE_ON_STARTUP - EEPROM_BASE_ADDRESS] =
                p_configuration_variables->ui8_street_mode_enabled;
        ui8_array[ADDRESS_RIDING_MODE_ON_STARTUP - EEPROM_BASE_ADDRESS] =
                p_configuration_variables->ui8_riding_mode;
        ui8_array[ADDRESS_LIGHTS_CONFIGURATION_ON_STARTUP - EEPROM_BASE_ADDRESS] =
                p_configuration_variables->ui8_lights_configuration;
        ui8_array[ADDRESS_STARTUP_BOOST_ON_STARTUP - EEPROM_BASE_ADDRESS] =
                p_configuration_variables->ui8_startup_boost_enabled;
        ui8_array[ADDRESS_ENABLE_AUTO_DATA_DISPLAY - EEPROM_BASE_ADDRESS] =
                p_configuration_variables->ui8_auto_display_data_enabled;
        ui8_array[ADDRESS_SOC_PERCENT_CALC - EEPROM_BASE_ADDRESS] =
                p_configuration_variables->ui8_soc_percent_calculation;
        ui8_array[ADDRESS_TORQUE_SENSOR_ADV_ON_STARTUP - EEPROM_BASE_ADDRESS] =
                p_configuration_variables->ui8_torque_sensor_adv_enabled;
