...
void pwm_init(void) {
	...
	TIM1_OC1Init(TIM1_OCMODE_PWM1, TIM1_OUTPUTSTATE_ENABLE, TIM1_OUTPUTNSTATE_ENABLE,
				 ...
				 TIM1_OCPOLARITY_HIGH, TIM1_OCPOLARITY_HIGH, TIM1_OCIDLESTATE_RESET, TIM1_OCNIDLESTATE_SET);
	...
	TIM1_OC4Init(TIM1_OCMODE_PWM1, TIM1_OUTPUTSTATE_DISABLE, PWM_COUNTER_MAX / 2, TIM1_OCPOLARITY_HIGH, TIM1_OCIDLESTATE_RESET);
